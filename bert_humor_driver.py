...
from pytorch_pretrained_bert.modeling import BertForSequenceClassification, BertConfig,MultimodalBertForSequenceClassification, IncongruityBertForSequenceClassification
...
bert_humor_ex = Experiment('bert_humor_transformer')
from sacred.observers import MongoObserver
from global_configs import *
url_database = conf_url_database
mongo_database_name = conf_mongo_database_name
bert_humor_ex.observers.append(MongoObserver.create(url= url_database ,db_name= mongo_database_name))
...
def prep_for_training(num_train_optimization_steps,_config):
    ...
    model = IncongruityBertForSequenceClassification.from_pretrained(_config["bert_model"],newly_added_config = _config,
